...
$search_sql = "SELECT * FROM products WHERE name LIKE '%" . $conn->real_escape_string($keyword) . "%'";
...
<body>
                        ...
                        <?php while ($product = $search_results->fetch_assoc()): ?>
                            <div class="col-md-4">
                                <div class="card product-card">
                                    <img src="<?php echo htmlspecialchars($product['image'] ?: 'path/to/default_image.jpg'); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($product['name']); ?>">
    ...
    <div class="d-grid gap-2">
        ...
        <a href="cart.php?add=<?php echo $product['id']; ?>" class="btn btn-success">Thêm vào giỏ hàng</a>
    </div>
</div>
                                </div>
                            </div>
