...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Kiểm tra xem người dùng đã đăng nhập chưa và lấy tên
    ...
    $sql = "INSERT INTO reviews (product_id, user_name, content) VALUES (?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("iss", $product_id, $user_name, $content);
...
<head>
    ...
    z-index: 10;
    width: 100%;
    margin-top: 570px; /* Khoảng cách từ trên cùng của trang đến footer */
}
    </style>
</head>
<body>
...
<div class="category-sidebar">
    ...
    <div class="container mt-4">
        ...
        <a href="admin_dashboard.php" class="btn btn-info mb-3 back-btn">Trở về trang Admin</a>
        ...
        <?php else: ?>
            <p class="alert alert-warning">Hiện tại chưa có đơn hàng nào.</p>
        <?php endif; ?>
    </div>
